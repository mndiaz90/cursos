...
import styles from "../styles/Matriculas.module.css";
import { MenuHeader } from "../src/components/MenuHeader";

import axios from 'axios'

interface MatriculaProps {
    dados: Array<DadosMatricula>
}
...
export default function Matriculas(props: MatriculaProps) {
        ...
        <>
            ...
            <div className='containerAllPages'>
                ...
                {props.dados && props.dados.map((curso, index) => {
                    return <ul key={index} className={styles.gridMatriculas} >
                        <li>{curso.id}</li>
...
Matriculas.getInitialProps = async () => {
